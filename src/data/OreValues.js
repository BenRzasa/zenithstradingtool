...
export const initialOreValsDict = {
  "True Rares": [
    ...
    { name: "Rhylazil", zenithVal: 0.02, johnVal: 0.02, nanVal: 0.02, customVal: 0.02},
    { name: "Ubriniale", zenithVal: 0.01, johnVal: 0.01, nanVal: 0.01, customVal: 0.01},
  ],
  ...
  "Surface / Shallow": [
    ...
    { name: "Aluminum", zenithVal: 250, johnVal: 150, nanVal: 200, customVal: 250},
    { name: "Copper", zenithVal: 250, johnVal: 300, nanVal: 250, customVal: 250},
    { name: "Iron", zenithVal: 250, johnVal: 150, nanVal: 250, customVal: 250},
    { name: "Sulfur", zenithVal: 150, johnVal: 75, nanVal: 200, customVal: 150},
    { name: "Silver", zenithVal: 150, johnVal: 75, nanVal: 200, customVal: 150},
    { name: "Zinc", zenithVal: 100, johnVal: 75, nanVal: 100, customVal: 100},
    { name: "Gold", zenithVal: 16, johnVal: 18, nanVal: 20, customVal: 16},
    { name: "Chlorophyte", zenithVal: 8, johnVal: 9, nanVal: 8, customVal: 8},
  ...
  "Caverns / Dusk": [
    ...
    { name: "Peridot", zenithVal: 6, johnVal: 6, nanVal: 6, customVal: 6},
    ...
    { name: "Diamond", zenithVal: 10, johnVal: 10, nanVal: 10, customVal: 10},
    { name: "Garnet", zenithVal: 7, johnVal: 7, nanVal: 8, customVal: 7},
    { name: "Platinum", zenithVal: 10, johnVal: 9, nanVal: 12, customVal: 10},
    { name: "Malachite", zenithVal: 4, johnVal: 4.5, nanVal: 6, customVal: 4},
    { name: "Lithium", zenithVal: 8, johnVal: 8, nanVal: 7, customVal: 8},
  ...
  "Volatile": [
    ...
    { name: "Plutonium", zenithVal: 10, johnVal: 10, nanVal: 12, customVal: 10},
    { name: "Technetium", zenithVal: 10, johnVal: 11, nanVal: 10, customVal: 10},
    { name: "Uranium", zenithVal: 12, johnVal: 14, nanVal: 9, customVal: 12},
    { name: "Caesium", zenithVal: 9, johnVal: 9, nanVal: 8, customVal: 9},
    { name: "Osmium", zenithVal: 10, johnVal: 10, nanVal: 9, customVal: 10},
  ...
  "Mystic / Inbetween": [
    ...
    { name: "Rainbonite", zenithVal: 5, johnVal: 2.5, nanVal: 4, customVal: 5},
    { name: "Barium", zenithVal: 6, johnVal: 6.5, nanVal: 6, customVal: 6},
    { name: "Chrysoprase", zenithVal: 10, johnVal: 10, nanVal: 10, customVal: 10},
    { name: "Soul Crystal", zenithVal: 15, johnVal: 15, nanVal: 15, customVal: 15},
    { name: "Cobalt", zenithVal: 7, johnVal: 7, nanVal: 10, customVal: 7},
    { name: "Lapis", zenithVal: 7, johnVal: 7, nanVal: 8, customVal: 7},
    { name: "Bismuth", zenithVal: 9, johnVal: 9, nanVal: 9, customVal: 9},
    { name: "Demonite", zenithVal: 5, johnVal: 5.5, nanVal: 6, customVal: 5},
  ...
  "Igneous / Mantle": [
    ...
    { name: "Magmium", zenithVal: 13, johnVal: 13, nanVal: 13, customVal: 13},
    ...
    { name: "Hellstone", zenithVal: 22, johnVal: 24, nanVal: 22, customVal: 22},
  ...
  "Mirage": [
    { name: "Frightstone", zenithVal: 40, johnVal: 40, nanVal: 35, customVal: 40},
    { name: "Stellarite", zenithVal: 4, johnVal: 4.5, nanVal: 3, customVal: 4},
    { name: "Prismaline", zenithVal: 4, johnVal: 4, nanVal: 4, customVal: 4},
    { name: "Antimatter", zenithVal: 12, johnVal: 12, nanVal: 10, customVal: 12},
    { name: "Constellatium", zenithVal: 5, johnVal: 5.5, nanVal: 6, customVal: 5},
  ...
  "Achrothesi / Whitespace": [
    ...
    { name: "Kreosyte", zenithVal: 6, johnVal: 8, nanVal: 8, customVal: 6},
  ...
  Quantum: [
    { name: "Gluonium", zenithVal: 3, johnVal: 2.5, nanVal: 2, customVal: 3},
  ...
  "Event Horizon": [
    { name: "Solarium", zenithVal: 25, johnVal: 29.5, nanVal: 20, customVal: 25},
    ...
    { name: "Chronon", zenithVal: 45, johnVal: 11, nanVal: 30, customVal: 45},
  ...
  Empyrean: [
    ...
    { name: "Wish Alloy", zenithVal: 10, johnVal: 13, nanVal: 7, customVal: 10},
    { name: "Phantasmorite", zenithVal: 9, johnVal: 8.5, nanVal: 5, customVal: 9},
    { name: "Profelis", zenithVal: 10, johnVal: 11.5, nanVal: 7, customVal: 10},
