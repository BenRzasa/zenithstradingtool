...
export const LayerGradients = {
    'Rares': { background: 'linear-gradient(135deg, #fdfcef 0%, #d3f8f8 20%, #faedfd 30%, #f2caff 37.5%, #ffffff 50%, #ffd9a1 62.5%, #edebd6 70%, #ecf9df 80%, #b7dce1 100%)'},
    'Uniques': { background: 'linear-gradient(112deg, #ffaa6e 0%, #ffa82e 17.8%, #ffdea9 27.9%, #dd7226 35.6%, #8b263d 51.6%, #dc672e 71.8%, #f8e3b6 80%, #f0b657 87.4%, #7e262c 100%)'},
    'Compounds': { background: 'linear-gradient(90deg, #1035ad 0%, #739ae4 20%, #fdfbfc 50%, #ecbf7a 80%, #7a4166 100%)'},
    'Surface / Shallow': { background: 'linear-gradient(180deg, rgb(110, 158, 96) 0%,rgb(160, 160, 160) 100%' },
    'Caverns / Dusk': { background: 'linear-gradient(180deg,rgb(192, 181, 161) 0%,rgb(39, 52, 99) 100%)' 
    },
    'Volatile': { background: 'rgb(228, 174, 126)' },
    'Mystic / Inbetween': { background: 'rgb(108, 137, 231)' },
    'Igneous / Mantle': { background: ' #d63636' },
    'Irradiated / Caustic': { background: 'linear-gradient(180deg, #49c73b 0%, #24a510 100%' },
    ...
    'Frigid': { background: ' #21b1b7' },
    'Marine': { background: ' #688cde' },
    'Cosmic': {
    ...
    'Interstice': {
      background: 'linear-gradient(180deg, #181c28 0%, #1e222f 20%, #30313d 30%,rgb(202, 202, 202) 50%, #676782 56%, #30313d 75%, #1e222f 85%, #181c28 100%)'
    },
    'Empyrean': {
    ...
    'Singularity Layer': {
      background: 'linear-gradient(90deg, #e3ccb1 0%, #d8b3ae 20%, #d6b4ba 36%, #cbb8bb 50%, #c6b0b3 60%, #d4b3b2 66%, #dab2b0 76%, #ffe9d1 100%)'
    }
  };